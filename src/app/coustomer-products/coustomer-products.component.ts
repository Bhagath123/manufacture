...
@Component({
  selector: 'app-coustomer-products',
  templateUrl: './coustomer-products.component.html',
  styleUrls: ['./coustomer-products.component.css']
})
export class CoustomerProductsComponent implements OnInit {
  products:any=[];
  category:any;
  modalService: any;
